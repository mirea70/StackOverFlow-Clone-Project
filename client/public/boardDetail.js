...
const url =
  "http://ec2-15-165-63-80.ap-northeast-2.compute.amazonaws.com:8080/";
...
const getData = async (id) => {
  await fetch(
    `http://ec2-15-165-63-80.ap-northeast-2.compute.amazonaws.com:8080/question/${id}`
  )
    .then((res) => {
      if (!res.ok) {
    ...
    .then((data) => {
      ...
      //   const answer_data = question_data[0].data;
      const answer_data = [];
      let today = new Date();
      ...
      qd_question_view.appendChild(
        document.createTextNode(question_data[0].view)
      );
      //question 컨테이너 렌더링
    ...
    .then((x) => {
      ...
      console.log(qd_lower_input_container, "qd_lower_input_container");
